...
public:
   ...
   */
  bool enqueue(RecipientNotificationPriority prio,
  ...
  /**
   * @brief Marks/unmarks this recipient as a flow recipient, depending on the
   * input boolean
   *
   * @return
   */
  inline void setFlowRecipient(u_int8_t _enabled) {
    flow_recipient = _enabled;
  };
  /**
   * @brief Marks/unmarks this recipient as a host recipient, depending on the
   * input boolean
   *
   * @return
   */
  inline void setHostRecipient(u_int8_t _enabled) {
    host_recipient = _enabled;
  };
  /**
