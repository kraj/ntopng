...
public:
  ...
  virtual void periodicUpdate([[maybe_unused]] Host *h,
                              [[maybe_unused]] HostAlert *engaged_alert){};
  ...
  inline void addCheck(std::list<HostCheck *> *l,
                       [[maybe_unused]] NetworkInterface *iface) {
    l->push_back(this);
  }
