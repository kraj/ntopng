...
public:
  ...
  inline void incnDPIStats(time_t when, ndpi_protocol_category_t ndpi_category,
                           [[maybe_unused]] u_int64_t sent_packets,
                           u_int64_t sent_bytes,
                           [[maybe_unused]] u_int64_t sent_goodput_bytes,
                           [[maybe_unused]] u_int64_t rcvd_packets,
                           u_int64_t rcvd_bytes,
                           [[maybe_unused]] u_int64_t rcvd_goodput_bytes) {
