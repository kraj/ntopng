...
bool ZMQParserInterface::parseContainerInfo(
  ...
  // container_info_data_type_k8s ? "K8S" : container_info->data_type ==
  // container_info_data_type_docker ? "DOCKER" : "UNKNOWN",
  // container_info->data_type
  // == container_info_data_type_k8s && container_info->data.k8s.name ?
  // container_info->data.k8s.name : "",
  // container_info->data_type == container_info_data_type_k8s &&
  // container_info->data.k8s.pod ? container_info->data.k8s.pod : "",
  // container_info->data_type == container_info_data_type_k8s &&
  // container_info->data.k8s.ns ? container_info->data.k8s.ns : "",
  // container_info->data_type == container_info_data_type_docker &&
  // container_info->data.docker.name ? container_info->data.docker.name : "");
