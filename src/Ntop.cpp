...
bool Ntop::recipients_enqueue(RecipientNotificationPriority prio,
...
#ifdef WIN32
  snprintf(plugins0_dir, sizeof(plugins0_dir), "%s\\plugins0",
           get_working_dir());
  snprintf(plugins1_dir, sizeof(plugins1_dir), "%s\\plugins1",
           get_working_dir());
#else
  snprintf(plugins0_dir, sizeof(plugins0_dir), "%s/plugins0",
           get_working_dir());
