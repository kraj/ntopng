...
static void compact_tree_funct(ndpi_patricia_node_t *node,
                               [[maybe_unused]] void *data, void *user_data) {
...
static void address_tree_dump_funct(ndpi_patricia_node_t *node,
